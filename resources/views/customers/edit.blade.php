                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('customer.update', $customer->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('user_marketing_id') is-invalid @enderror" id="user_marketing_id" name="user_marketing_id" required>
                                    ...
                                    @foreach ($userMarketings as $userMarketing)
                                        <option value="{{ $userMarketing->id }}" {{ old('user_marketing_id', $customer->user_marketing_id) == $userMarketing->id ? 'selected' : '' }}>{{ $userMarketing->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('province') is-invalid @enderror" id="province" name="province" value="{{ old('province', $customer->province) }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('postal_code') is-invalid @enderror" id="postal_code" name="postal_code" value="{{ old('postal_code', $customer->postal_code) }}" required>
