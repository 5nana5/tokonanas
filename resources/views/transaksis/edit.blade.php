                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('product_id') is-invalid @enderror" id="product_id" name="product_id" required>
                                            ...
                                            @foreach ($produks as $produk)
                                                <option value="{{ $produk->id }}" {{ old('product_id', $transaksi->product_id) == $produk->id ? 'selected' : '' }}>{{ $produk->name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('quantity') is-invalid @enderror" id="quantity" name="quantity" value="{{ old('quantity', $transaksi->quantity) }}" min="1" required>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('total_price') is-invalid @enderror" id="total_price" name="total_price" value="{{ old('total_price', $transaksi->total_price) }}" step="0.01" min="0" required>
