...
<head>
    ...
    <title>Tambah User Marketing</title>
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0"><i class="fas fa-plus-circle"></i> Tambah User Marketing</h4>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('user_marketings.store') }}" method="POST">
                            @csrf
